...
<x-layout>
    ...
    <div class="flex flex-col items-center justify-center min-h-screen customBackground">
        ...
        <form action="{{ route('contact.submit') }}" method="POST" class="max-w-md w-full bg-white p-8 rounded shadow-lg">
            @csrf
            <div class="mb-4">
